...
namespace ThoughtHub.Extensions
{
	public static class EndpointRouteBuilderExtensions
	{
		...
		public static IEndpointConventionBuilder MapIdentityApi(this IEndpointRouteBuilder endpoints)
		{
			...
			routeGroup.MapPost("/register", async Task<Results<Ok, ValidationProblem>>
				([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp, [FromServices] IEventPublisher eventPublisher) =>
			{
